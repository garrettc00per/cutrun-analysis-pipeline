...
params.outdir = "${projectDir}/processed_bams_pe"
...
log.info """\
    ...
    genome sizes   : ${params.genome_sizes}
    """
    .stripIndent()

// Create channel from sample list and link to BAM files
Channel
...
// Process definition
process PROCESS_BAM {
    publishDir "${params.outdir}", mode: 'copy', pattern: "${sample_id}_final*"
